...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <asp:DataList ID="DataList7" runat="server">
        <ItemTemplate>
            <table class="auto-style6">
                <tr>
                    <td>
                        <asp:Label ID="Label12" runat="server" Text='<%# Eval("sonucad") %>'></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
    ...
    <asp:Panel ID="Panel1" runat="server">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TextBox2" runat="server" style="margin-left: 0px" Width="347px"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="margin-left: 40px">
                <asp:Button ID="Button2" runat="server" style="text-align: center; font-size:15pt;" Text="İletiniz" Width="157px" OnClick="Button2_Click" />
            </td>
        </tr>
    </table>
